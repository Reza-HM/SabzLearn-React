...
const Landing = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      const res = await fetch("https://sabzlearnreactserver.iran.liara.run:4000/v1/infos/index");
  ...
  return (
    <section className="landing">
      <div className="container">
        ...
        <div className="w-[700px] relative my-14 mx-auto">
          <input
            type="text"
            className="w-full p-10 rounded-2xl text-slate-600"
            placeholder="چه چیزی دوست داری یاد بگیری ..."
            value={globalSearchValue}
            onChange={(event) => setGlobalSearchValue(event.target.value)}
          />
          <button
            className="bg-primary absolute left-4 w-24 top-[0.75rem] h-24 rounded-2xl"
        ...
        <div className="flex justify-evenly items-center">
          <div className="flex flex-col justify-center items-center">
            ...
            <LandingCounter count={indexInfos.usersCount} speed={100} />
            <span className="font-bold">کاربر توی سبزلرن ثبت نام کردن</span>
          </div>
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <LandingCounter count={indexInfos.coursesCount} speed={100} />
          ...
          <div className="flex flex-col justify-center items-center">
            ...
            <LandingCounter count={indexInfos.totalTime} speed={100} />
